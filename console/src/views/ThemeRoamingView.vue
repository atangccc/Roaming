      ...
      <header class="tr-topbar">
        <div class="tr-brand">
          <span class="tr-brand-mark" aria-hidden="true">
            <svg viewBox="0 0 1024 1024"><defs><linearGradient id="brand-surface" x1="110" y1="90" x2="920" y2="940" gradientUnits="userSpaceOnUse"><stop stop-color="#8179e9"/><stop offset=".45" stop-color="#bd7dce"/><stop offset=".73" stop-color="#e994b6"/><stop offset="1" stop-color="#68bdca"/></linearGradient></defs><rect x="72" y="72" width="880" height="880" rx="232" fill="url(#brand-surface)"/><rect x="238" y="270" width="488" height="368" rx="90" fill="#fff" fill-opacity=".3" transform="rotate(-7 482 454)"/><rect x="294" y="330" width="488" height="368" rx="90" fill="#fff"/><circle cx="388" cy="422" r="24" fill="#e58cb4"/><circle cx="452" cy="422" r="24" fill="#887ddb"/><circle cx="516" cy="422" r="24" fill="#5db3c0"/><path d="M382 520h294l-55-50m55 50-55 50M694 608H400l55 50m-55-50 55-50" fill="none" stroke="#81768f" stroke-width="24" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </span>
