      ...
      <header class="tr-topbar">
        <div class="tr-brand">
          <span class="tr-brand-mark" aria-hidden="true">
            <svg viewBox="0 0 1024 1024"><defs><linearGradient id="brand-line" x1="120" y1="100" x2="910" y2="930" gradientUnits="userSpaceOnUse"><stop stop-color="#e879ad"/><stop offset=".38" stop-color="#9c83dd"/><stop offset=".72" stop-color="#55add1"/><stop offset="1" stop-color="#62c58f"/></linearGradient><linearGradient id="brand-upper" x1="160" y1="230" x2="520" y2="430" gradientUnits="userSpaceOnUse"><stop stop-color="#ffafd0"/><stop offset="1" stop-color="#b5a1e9"/></linearGradient><linearGradient id="brand-lower" x1="500" y1="760" x2="880" y2="960" gradientUnits="userSpaceOnUse"><stop stop-color="#8ed2ef"/><stop offset="1" stop-color="#89dcae"/></linearGradient></defs><path d="M781.141 447.829H242.859a204.8 204.8 0 0 1 0-409.6h538.282a204.8 204.8 0 0 1 0 409.6zM242.859 89.429a153.6 153.6 0 0 0 0 307.2h538.282a153.6 153.6 0 0 0 0-307.2z" fill="url(#brand-line)"/><path d="M475.989 232.277H178.517a99.157 99.157 0 0 0 0 198.315h297.472a99.157 99.157 0 1 0 0-198.315z" fill="url(#brand-upper)" opacity=".5"/><path d="M824.149 769.024H526.677a99.157 99.157 0 1 0 0 198.315h297.472a99.157 99.157 0 1 0 0-198.315z" fill="url(#brand-lower)" opacity=".5"/><path d="M781.141 986.112H242.859a204.8 204.8 0 0 1 0-409.6h538.282a204.8 204.8 0 0 1 0 409.6zM242.859 627.712a153.6 153.6 0 0 0 0 307.2h538.282a153.6 153.6 0 0 0 0-307.2zM781.141 313.344a70.485 70.485 0 1 1 70.486-70.485 70.485 70.485 0 0 1-70.486 70.485zm0-89.771a19.285 19.285 0 1 0 19.286 19.286 19.456 19.456 0 0 0-19.286-19.286zM242.859 851.627a70.485 70.485 0 1 1 70.485-70.486 70.485 70.485 0 0 1-70.485 70.486zm0-89.771a19.285 19.285 0 1 0 19.285 19.285 19.456 19.456 0 0 0-19.285-19.285z" fill="url(#brand-line)"/></svg>
          </span>
